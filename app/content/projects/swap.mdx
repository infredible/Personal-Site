...
We had an opportunity to address one major pain-point of the Ethereum ecosystem when it came to interacting between dApps and wallets: token approvals. While "signing" a transaction in a wallet may be an intuitive security feature, token approvals can add one or two steps to a transaction, also adding network fees in the process.
dApps and wallets: token approvals. While "signing" a transaction in a wallet may be an 
intuitive security feature, token approvals can add one or two steps to a transaction, also 
adding network fees in the process.
...
<video 
  src="/videos/projects/Permit2.mp4" 
  autoPlay 
  loop 
  muted 
  playsInline
...
![UniswapX](/images/projects/uniswapx.png)


{/* Video with border */}
<div className="video-container with-border">
  <video 
    src="/videos/projects/uniswapx-prototype.mp4" 
    autoPlay 
    loop 
    muted 
    playsInline
...
<video 
  src="/videos/projects/limits.mp4" 
  controls
  autoPlay 
  loop 
  muted 
...
{/* Basic video embedding */}
<video 
  src="/videos/projects/bridging.mp4" 
  autoPlay 
  loop 
  muted 
  playsInline
